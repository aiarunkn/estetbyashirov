...
export const content: Record<Locale, Dictionary> = {
  ru: {
    ...
    founder: {
      ...
      story: [
        "Estet by Ashirov — это сеть салонов красоты, созданная с любовью к профессии, высоким стандартам сервиса и заботой о здоровье волос.",
        "Основатель бренда — Азамат Аширов, международный судья в сфере парикмахерского искусства. Бренд Estet by Ashirov является членом международной ассоциации парикмахеров OMC (Италия).",
        "За более чем 10 лет работы Азамат создал собственную профессиональную линейку продукции: осветляющий порошок, шампуни, бальзамы, профессиональные фены и другие продукты для ухода за волосами.",
        "Сегодня Estet by Ashirov — это четыре салона красоты в Алматы и Астане, где работают сильные специалисты, применяются авторские техники окрашивания и поддерживаются международные стандарты качества.",
      ...
      quote: "Estet by Ashirov — это не просто салон красоты, а авторский бренд с единой философией и высокими стандартами качества.",
    },
    gallery: {
      eyebrow: "Моменты",
      title: "Жизнь ESTET",
